...
-- Làm mới dữ liệu mẫu theo chủ đề thể thao.
...
INSERT INTO Products (Id, Name, Description, Price, StockQuantity, ImageUrl, CategoryProductId, SalePrice, IsNew, IsBestSeller, IsPromo, IsDeleted) VALUES
...
INSERT INTO Customers (Id, FullName, Email, Phone, Address, Gender, Password) VALUES
...
INSERT INTO Orders (Id, OrderDate, CustomerId, Status, Notes, DeliveryAddress, PaymentMethod, IsPaid) VALUES
